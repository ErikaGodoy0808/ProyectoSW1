...
<body>
    ...
    <div class="container mt-5">
        <hr width="500px" align="center" size="500px" ></hr><!-- separa por medio de una linea -->
        <h1 align="center">LISTADO ESTUDIANTES</h1>
        <hr width="500px" align="center" size="500px" ></hr><!-- separa por medio de una linea -->

        <!-- creacion de tabla contenedora del listado  -->
            ...
            <tbody>
                <%
                    try {
                        ...
                        rs = st.executeQuery("SELECT id_est, nom_est, ape_est, ed_est, em_est, id_curso, gen_est FROM `estudiantes`");
